...
//Code Here
var evenNumbers = mixedNumbers.filter( (x) =>{
  return x % 2 === 0;
})
...
//Code Here
let totalPopulation = populations.reduce( (prev, curr) => {
  return prev + curr
})
...
let bobsTotal = purchases.reduce( (total, item) => { return item["owner"] === "Bob" ? total + item["price"] : total }, 0)
